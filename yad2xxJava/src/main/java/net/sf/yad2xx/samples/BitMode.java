...
public class BitMode extends AbstractSample {
    ...
    /**
     * Select last 8 bits of an integer value.
     */
    private static final int BYTE_MASK = 0xFF;

    /**
     * Alternating bit values to test output.
     */
    private static final int TEST_VALUE = 0xA5;
    ...
    private void run() {
        ...
        try {
            ...
            dev.setBitMode((byte) BYTE_MASK,
                    FTDIBitMode.FT_BITMODE_ASYNC_BITBANG); // all as outputs

            /*
             * In bit-bang mode, setting the baud rate gives a clock rate 16
             * times higher,
             * e.g. baud = 9600 gives 153600 bytes per second.
             */
            ...
            /*
             * Use FT_Write to set values of output pins.
             */
            byte outputData = (byte) TEST_VALUE;
            dev.write(outputData);

            /*
             * Despite its name, GetBitMode samples the values of the data
             * pins.
             */
            ...
            if (pinStatus != outputData) {
                ...
                out.print(Integer.toHexString(pinStatus & BYTE_MASK));
                out.print(" but expected 0x");
                out.println(Integer.toHexString(outputData & BYTE_MASK));
            }
