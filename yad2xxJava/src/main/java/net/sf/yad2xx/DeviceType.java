 ...
 * 1.4.4.
 * <p>
 * Basically a bunch of hardcoded values to indicate the functions supported by
...
public enum DeviceType {
    ...
    FT_DEVICE_X_SERIES(9, false, false, false), // TODO - check datasheet
    FT_DEVICE_4222H_0(10, false, false, false), // TODO - check datasheet
    FT_DEVICE_4222H_1_2(11, false, false, false), // TODO - check datasheet
    FT_DEVICE_4222H_3(12, false, false, false), // TODO - check datasheet
    FT_DEVICE_4222_PROG(13, false, false, false); // TODO - check datasheet
    ...
    /**
     * FT2232D, FT232H, FT2232H and FT4232H have a Multi Purpose Synchronous
     * Serial Engine (MPSSE) mode.
     */
     ...
     * Return C enum value.
     *
     * @return FTDI defined type value as specified in ftd2xx.h
     */
    public int getType() {
        return type;
    }
