...
public class FTDIInterface {
     ...
     *
     * @param ftHandle          FT4222 device handle
     * @param ioLine            SPI transmission lines - single, dual or quad
     * @param div               system clock divider
     * @param cpol              SPI bus CLK pin polarity
     * @param cpha              selects clock edge to shift and sample
     * @param ssoMap            Slave selection output pins
     * @throws FTDIException    API call failed, see exception fields for details. More
     *                          information can be found in AN_329.
     * @throws IllegalStateException
     *                          Device must be opened before calling this method.
     * @see                     FT4222Device#spiMasterInit(SpiMode, SpiClock, SpiCPolarity, SpiCPhase, int)
     * @since   2.1
     */
     ...
     *
     * @param ftHandle          FT4222 device handle
     * @param spiMode           SPI transmission lines - single, dual or quad
     * @throws FTDIException    API call failed, see exception fields for details. More
     *                          information can be found in AN_329.
     * @throws IllegalStateException
     *                          Device must be opened before calling this method.
     ...
     *
     * @param ftHandle          FT4222 device handle
     * @param buffer            buffer that receives the data from the device
     * @param bytesToRead       number of bytes to read from the device
     * @param isEndTransaction  If TRUE the Slave Select pin will be raised at the end of the read 
     ...
     *
     * @param ftHandle          FT4222 device handle
     * @param spiIdx            The index of the SPI transaction
     * @throws FTDIException    API call failed, see exception fields for details. More
     *                          information can be found in AN_329.
