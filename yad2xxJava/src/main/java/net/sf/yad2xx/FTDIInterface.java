...
public class FTDIInterface {
     ...
     * @throws FTDIException         API call failed, see exception fields for details. More
     *                               information can be found in AN_329.
     * @throws IllegalStateException Device must be opened before calling this method.
    ...
    //TODO added by Peter
    /**
     * Added by PeterV 06.06.2020
     * Initialize the GPIO interface of the FT4222H.
     *
     * @param ftHandle FT4222 device handle
     * @throws FTDIException FT4222_GPIO_Init returned a non-zero status code
     * @since 2.2
     */
    static native void gpioInit(long ftHandle) throws FTDIException;
     ...
     * @since 2.2
     */
    static native int gpioRead(long ftHandle) throws FTDIException;
    ...
    If the I2C bus encounters errors or works abnormally,
    this function will reset the I2C device. It is
    not necessary to call I2CMaster_Init again after
    calling this reset function. This function will
    maintain the original i2c master setting and clear
    all cache in the device. D2XX has similar
    function(FT_PURGE) but strongly recommend to use FT4222_I2CMaster_Reset.


     */
    static native void i2cMasterReset(long ftHandle) throws FTDIException;
